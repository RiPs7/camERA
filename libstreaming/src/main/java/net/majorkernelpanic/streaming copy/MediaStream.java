...
import perimara.era.streaming.rtp.AbstractPacketizer;
...
public abstract class MediaStream implements Stream {
	 ...
	 * {@link VideoStream#setVideoQuality(perimara.era.streaming.video.VideoQuality)}
	 * for a {@link VideoStream} and {@link AudioStream#setAudioQuality(perimara.era.streaming.audio.AudioQuality)}
	...
	/**
	 * Returns the SSRC of the underlying {@link perimara.era.streaming.rtp.RtpSocket}.
	...
	protected void createSockets() throws IOException {
		...
		if (sPipeApi == PIPE_API_LS) {
			...
			final String LOCAL_ADDR = "perimara.era.streaming-";
