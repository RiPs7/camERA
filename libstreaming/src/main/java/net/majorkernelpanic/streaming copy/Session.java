...
package perimara.era.streaming;
...
import perimara.era.streaming.audio.AudioQuality;
import perimara.era.streaming.audio.AudioStream;
import perimara.era.streaming.exceptions.CameraInUseException;
import perimara.era.streaming.exceptions.ConfNotSupportedException;
import perimara.era.streaming.exceptions.InvalidSurfaceException;
import perimara.era.streaming.exceptions.StorageUnavailableException;
import perimara.era.streaming.gl.SurfaceView;
import perimara.era.streaming.rtsp.RtspClient;
import perimara.era.streaming.video.VideoQuality;
import perimara.era.streaming.video.VideoStream;
...
public class Session {
	...
	public Session() {
		...
		HandlerThread thread = new HandlerThread("perimara.era.streaming.Session");
		thread.start();
